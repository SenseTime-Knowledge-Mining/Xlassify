...
def start_rf(train_index, valid_index, fold, seed):
    print(f'Fold:{fold}')
    ...
    clf = RandomForestClassifier(n_estimators=300, # 500
                criterion="gini",
                max_depth=None,
                min_samples_split=2,
                min_samples_leaf=1,
                ...
                bootstrap=True,
                oob_score=False, # False, yw: True
                n_jobs=2, # None
                random_state=global_seed, # None, yw: 8
                verbose=1,)
    print("start fit")
...
if __name__ == '__main__':
    ...
    for seed in kfold_seeds:
        ...
        for train_index,test_index in kf.split(item_df.index, item_df["label_name"]):
            ...
            pred_tmp = start_rf(train_index, test_index, fold, seed)
